...
'TRAVIS_REPO_INTERNETARCHIVE','TRAVIS_REPO_RDRYAD',
'TRAVIS_REPO_ZENODO','TRAVIS_REPO_RRLITE','TRAVIS_REPO_REDISAPI','TRAVIS_REPO_OPENCONTEXT',
'TRAVIS_REPO_ROTL','TRAVIS_REPO_USABOUNDARIESDATA','TRAVIS_REPO_MAPR',
'TRAVIS_REPO_RUSDA','TRAVIS_REPO_RSTARS','TRAVIS_REPO_SOFA','TRAVIS_REPO_GENDERDATA',
'TRAVIS_REPO_RDAT','TRAVIS_REPO_FISHBASEAPI',
'TRAVIS_REPO_TEXTREUSE','TRAVIS_REPO_STPLANR',
'TRAVIS_REPO_BRRANCHING','TRAVIS_REPO_OAI',
'TRAVIS_REPO_SOLRIUM', 'TRAVIS_REPO_RGEOSPATIALQUALITY', 'TRAVIS_REPO_GEOOPS',
'TRAVIS_REPO_VCR', 'TRAVIS_REPO_GEOJSONLINT', 'TRAVIS_REPO_GEOJSON',
'TRAVIS_REPO_GDOC', 'TRAVIS_REPO_ATOMIZE', 'TRAVIS_REPO_CORED',
'TRAVIS_REPO_ASPACER', 'TRAVIS_REPO_APIPKGEN',
...
'TRAVIS_REPO_DISCGOLF','TRAVIS_REPO_HTTPCODE','TRAVIS_REPO_SERRANO',
'TRAVIS_REPO_EXTRACTR','TRAVIS_REPO_TEXTMINER',
'TRAVIS_REPO_RPHYLOPIC','TRAVIS_REPO_OPENADDS','TRAVIS_REPO_HABANERO',
'TRAVIS_REPO_PYGBIF','TRAVIS_REPO_PYOBIS','TRAVIS_REPO_DAPPR',
'TRAVIS_REPO_INIR','TRAVIS_REPO_RJSONAPI','TRAVIS_REPO_REQUEST',
'TRAVIS_REPO_SPENV','TRAVIS_REPO_SPPLIT','TRAVIS_REPO_GEOAXE',
'TRAVIS_REPO_SCRUBR','TRAVIS_REPO_MREGIONS','TRAVIS_REPO_SPPLIST',
'TRAVIS_REPO_SPLISTER','TRAVIS_REPO_GETLANDSAT',
'TRAVIS_REPO_RREDLIST','TRAVIS_REPO_RWDPA','TRAVIS_REPO_ORIGINR',
'TRAVIS_REPO_DIRDF', 'TRAVIS_REPO_EECHIDNA', 'TRAVIS_REPO_HISTORYDATA',
'TRAVIS_REPO_HUNSPELL', 'TRAVIS_REPO_JSONVALIDATE', 'TRAVIS_REPO_OPENCAGE',
'TRAVIS_REPO_ROBOTSTXT', 'TRAVIS_REPO_ROPENAQ', 'TRAVIS_REPO_TAXA',
