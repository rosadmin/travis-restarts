...
task :runtravis do
  ...
  repos = ['TRAVIS_REPO_ALM','TRAVIS_REPO_ANTWEB','TRAVIS_REPO_ECOENGINE',
    ...
    'TRAVIS_REPO_INTERNETARCHIVE','TRAVIS_REPO_CARTOGRAPHER','TRAVIS_REPO_ENIGMA',
    'TRAVIS_REPO_RSUNLIGHT','TRAVIS_REPO_RTIMES','TRAVIS_REPO_PYTAXIZE',
    'TRAVIS_REPO_HTTSNAP','TRAVIS_REPO_ANALOGSEA','TRAVIS_REPO_CANADIANA',
    'TRAVIS_REPO_HTTPING','TRAVIS_REPO_COWSAY','TRAVIS_REPO_DISCGOLF',
